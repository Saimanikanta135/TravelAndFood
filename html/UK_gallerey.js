...
function header()
{
    ...
    {
        i=0;
        document.getElementById("header").style.backgroundImage=`url(../assets/images/UK/${imagesarray[i]})`
...
// gallery code 
        ...
        {
            img[i].src=`../assets/images/UK/${i}.jpg`
...
function openTheImage(img,matter,par){
    console.log(img)
    document.getElementById("bigimg").setAttribute("src",`../assets/images/UK/${img}.jpg`)
