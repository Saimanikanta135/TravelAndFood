...
function header()
{
    ...
    {
        i=0;
        document.getElementById("header").style.backgroundImage=`url(../assets/images/USA/${imagesarray[i]})`
...
// gallery code 
        ...
        {
            img[i].src=`../assets/images/USA/${i}.jpg`
...
function openTheImage(img,matter,par){
    console.log(img)
    document.getElementById("bigimg").setAttribute("src",`../assets/images/USA/${img}.jpg`)
